describe('Blog app', function() {
  ...
  describe('when logged in', function() {
    beforeEach(function(){
      ...
      cy.createBlog({ title: 'Node for dumbasses', author: 'Sarah Connor', url: 'www.overgourge.com', likes: 15 })
      cy.createBlog({ title: 'Typing the script', author: 'Joe L. Markel', url: 'www.tforthee.com', likes: 12 })
      cy.createBlog({ title: 'Reacting to the DOM', author: 'Some old guy', url: 'www.iklin.com', likes: 7 })
      cy.createBlog({ title: 'Programming with Java', author: 'The dude', url: 'www.zdevel.com', likes: 3 })
      cy.visit('http://localhost:3000')
    })
    ...
    it('the blogs are ordered by number of likes', function() {
      cy
        ...
        .then((likes) => {
          ...
          expect(JSON.stringify(sortedLikes.sort((a, b) => b - a)) === JSON.stringify(likes)).to.be.true
        })
    })
  })
})